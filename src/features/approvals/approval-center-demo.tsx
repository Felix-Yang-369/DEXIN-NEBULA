...
> = {
  draft: {
    label: "草稿",
    tone: "bg-[#f3f6f5] text-muted-foreground",
    description: "尚未提交",
  },
  pending_department: {
    label: "部门负责人审批中",
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      {[
        ...
        <div className="rounded-xl bg-[#f3f7fa] px-4 py-3" key={label}>
...
export function ApprovalCenterDemo() {
  ...
  if (!isReady) {
    return (
      <div className="rounded-[22px] border border-border/80 bg-white p-8 text-center text-xs text-muted-foreground">
        正在读取本机演示流程…
      </div>
    );
  }
  ...
  if (!request) {
    return (
      <section className="rounded-[22px] border border-border/80 bg-white p-8 text-center">
        <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-[#eaf3f8] text-primary">
        ...
        <Link
          className="mt-6 inline-flex h-10 items-center gap-2 rounded-xl bg-primary px-4 text-xs font-medium text-primary-foreground"
          href="/requests/leave"
        >
              ...
              <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
                <div>
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <span
                      className={`rounded-full px-3 py-1.5 text-[9px] font-medium ${status.tone}`}
                    >
                      {status.label}
                    </span>
                  </div>
                ...
                <aside className="rounded-[18px] border border-border bg-[#fafcfe] p-5">
                  ...
                  <label className="mt-4 block">
                    ...
                    <textarea
                      className="mt-2 min-h-24 w-full resize-y rounded-xl border border-border bg-white px-3 py-2.5 text-xs leading-5 outline-none focus:border-primary/35 focus:ring-4 focus:ring-primary/7"
                      onChange={(event) => {
                  ...
                  {feedback && (
                    <div className="mt-3 rounded-xl bg-[#fff8ee] px-3 py-2 text-[10px] text-[#8b6d46]">
                      {feedback}
                    </div>
                  )}
                  <button
                    className="mt-4 inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-primary text-xs font-medium text-primary-foreground"
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2">
                    <button
                      className="h-9 rounded-xl border border-[#f0dfc7] bg-[#fff8ee] text-[10px] font-medium text-[#8b612c]"
                    ...
                    <button
                      className="h-9 rounded-xl border border-[#ead8d8] bg-[#f8eeee] text-[10px] font-medium text-[#965151]"
          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="mt-5 flex flex-wrap justify-end gap-3">
              ...
              {request.status === "pending_department" && (
                <button
                  className="inline-flex h-10 items-center gap-2 rounded-xl border border-[#ead8d8] bg-[#f8eeee] px-4 text-xs font-medium text-[#965151]"
              ...
              {isTerminal && (
                <button
                  className="inline-flex h-10 items-center gap-2 rounded-xl border border-border bg-white px-4 text-xs font-medium text-muted-foreground"
                  onClick={() => {
                    clearRequest();
                    setFeedback("");
                  }}
        ...
        {view === "history" && (
          <div className="grid gap-6 p-5 sm:p-6 xl:grid-cols-[minmax(0,1fr)_380px]">
            ...
            <aside className="rounded-[18px] bg-[#0a385d] p-5 text-white">
              ...
              {isTerminal && (
                <button
                  className="mt-5 inline-flex h-9 items-center gap-2 rounded-xl border border-white/12 bg-white/8 px-3 text-[10px] text-white/70"
                  onClick={() => {
                    clearRequest();
                    setView("pending");
                  }}
