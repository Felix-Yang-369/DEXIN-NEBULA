        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-2">
          ...
          <label className="block">
            ...
            <div className="relative mt-2">
              ...
              <input
                className="h-11 w-full rounded-xl border border-border bg-[#fafcfe] pl-9 pr-3 text-xs outline-none focus:border-primary/35 focus:ring-4 focus:ring-primary/7"
                max="1000000"
                min="0.01"
                name="amount"
