    ...
    <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
      ...
      >
        <div className="flex items-center gap-3 border-b border-border/80 pb-5">
          <span className="grid size-10 place-items-center rounded-xl bg-[#f3edfa] text-[#76589c]">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-border bg-[#fafcfe] p-4">
            <input
              checked={isExternal}
          ...
          <label className="block rounded-xl border border-border bg-[#fafcfe] p-4">
      ...
      <aside className="space-y-5">
          ...
          <ol className="mt-4 space-y-3">
            {route.map((step, index) => (
              <li className="flex items-center gap-3" key={step.code}>
                <span className="grid size-6 shrink-0 place-items-center rounded-full bg-[#eaf3f8] text-[9px] font-semibold text-primary">
                  {index + 1}
                </span>
        ...
        <section className="rounded-[22px] bg-[#0a385d] p-5 text-white">
          <div className="flex items-center gap-2 text-[#79d8d5]">
