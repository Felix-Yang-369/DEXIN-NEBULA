...
export function ProductMasterForm({
  ...
  const input =
    "mt-1.5 h-10 w-full rounded-xl border border-input bg-white px-3 text-xs text-foreground outline-none focus:border-primary/40";
  const textarea =
    "mt-1.5 min-h-24 w-full rounded-xl border border-input bg-white p-3 text-xs leading-5 text-foreground outline-none focus:border-primary/40";
  return (
    <form action={saveProductFullAction} className="mt-5 space-y-5">
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <label className="text-[10px] text-muted-foreground sm:col-span-2 xl:col-span-4">
          产品英文名称
          <input className={input} defaultValue={product?.name_en ?? ""} name="nameEn" />
        </label>
      </section>

      <section className="grid gap-3 rounded-2xl bg-[#f6f9f7] p-4 sm:grid-cols-2 xl:grid-cols-4">
        <label className="text-[10px] text-muted-foreground">
          规格
        ...
        <div className="flex items-end gap-4 pb-2 text-[10px] text-muted-foreground">
      ...
      <section className="grid gap-3 rounded-2xl border border-[#dce9e3] bg-[#f7faf9] p-4 lg:grid-cols-3">
        <label className="text-[10px] text-muted-foreground">
          客户查询回复话术
      ...
      <div className="flex justify-end">
        <button className="h-10 rounded-xl bg-[#0a385d] px-5 text-xs font-medium text-white" type="submit">
