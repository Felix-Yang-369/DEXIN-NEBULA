  ...
  return groups.map((group) => {
    return (
      <section className="mb-5" key={group.label}>
        <div className="mb-2 flex items-center gap-2 px-3 text-[9px] font-semibold tracking-[0.14em] text-[#79d8d5]/52">
            ...
            return (
              <div className="relative" key={`${group.label}-${item.label}`}>
                <Link
                  ...
                  className={`group/item relative flex min-h-10 items-center gap-3 overflow-hidden rounded-[13px] py-2 pl-3 text-[13px] transition-all duration-200 ${
