  ...
  return (
    ...
    >
      <main className="mx-auto max-w-[1200px] p-4 sm:p-6 xl:p-8">
        <Link
          className="inline-flex h-9 items-center gap-2 rounded-md border border-border bg-white px-3 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          href="/knowledge"
        >
        ...
        <section className="relative mt-4 overflow-hidden rounded-md bg-primary px-6 py-8 text-white  sm:px-9 sm:py-10">
          ...
          <div className="relative max-w-3xl">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs tracking-[0.13em] text-white/42">
                INTERNAL · V{document.version}
              </span>
            </div>
            {document.title_en && (
              <div className="mt-7 text-xs font-medium tracking-[0.16em] text-muted-foreground">
        ...
        <div className="mt-5 grid items-start gap-5 lg:grid-cols-[minmax(0,1fr)_290px]">
          <article className="rounded-md border border-border/80 bg-white px-6 py-7  sm:px-9 sm:py-10">
