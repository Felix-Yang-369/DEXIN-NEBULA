  ...
  return (
    <PlatformRouteStateShell loadingLabel="收付款单">
      ...
      >
        ...
        <section className="min-h-[196px] overflow-hidden rounded-md bg-card px-6 py-8 sm:px-8">
          <div className="h-3 w-24 animate-pulse rounded bg-white/15 motion-reduce:animate-none" />
          <div className="mt-5 h-2.5 w-44 animate-pulse rounded bg-muted motion-reduce:animate-none" />
          <div className="mt-4 h-9 w-56 max-w-full animate-pulse rounded-md bg-white/20 motion-reduce:animate-none" />
        ...
        <div className="mt-5 flex h-11 w-[184px] rounded-md bg-muted p-1">
        ...
        <div className="mt-5 grid items-start gap-5 xl:grid-cols-[minmax(0,1.4fr)_minmax(380px,.6fr)]">
          <section className="min-h-[620px] overflow-hidden rounded-md border border-border/70 bg-white">
            ...
            <div className="space-y-3 p-4 sm:p-5">
              {[0, 1, 2].map((item) => (
                <article
                  className="min-h-[136px] rounded-md border border-border/70 bg-muted p-4"
                  key={item}
                >
          ...
          <section className="min-h-[620px] rounded-md border border-border/70 bg-white p-5 sm:p-6">
            <Skeleton className="h-5 w-28" />
