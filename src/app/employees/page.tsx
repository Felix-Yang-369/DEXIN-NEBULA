      ...
      <main className="mx-auto max-w-[1440px] p-4 sm:p-6 xl:p-8">
          <section className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                className="h-10 rounded-md border border-border bg-card px-4 text-xs font-medium"
                type="button"
              >
                批量导入
              </button>
            ...
            <div className="space-y-5">
              <section className="overflow-hidden rounded-md border border-border/75 bg-card">
                <div className="border-b border-border/70 p-5 sm:px-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {["全部部门", "全部职位", "全部账号状态"].map((filter) => (
                      <button
                        className="h-8 rounded-lg border border-border bg-muted px-3 text-xs text-muted-foreground"
                        type="button"
                        key={filter}
                      >
                        {filter}　⌄
                ...
                <div className="px-6 py-16 text-center">
                  <div className="mx-auto grid size-12 place-items-center rounded-lg bg-muted text-sm font-semibold text-primary">
                    员
                  </div>
                  ...
                  <div className="mt-5 flex justify-center gap-2">
                    <button
                      className="h-9 rounded-md border border-border bg-white px-4 text-xs font-medium"
                      type="button"
                    >
                      下载模板
                    </button>
                  ...
                  {archiveGroups.map((group) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span
                          className={`grid size-8 place-items-center rounded-md text-xs font-semibold ${group.tone}`}
                        >
                          {group.mark}
                        </span>
              ...
              <section className="rounded-md border border-border/75 bg-card p-5 sm:p-6">
                ...
                <div className="mt-5 space-y-3">
                  {onboardingSteps.map((step, index) => (
                    <div
                      className="flex items-center gap-3 rounded-md border border-border/70 bg-muted p-3"
                      key={step.mark}
                    >
                      <span
